        ...
        <div className='inner-box'>
          ...
          <div className='fighters'>
            <div className='fighter1'>
              <img
                className='fighter1Img'
                src={FightImg1}
                alt=''
                style={{ top: `${fighter1Top}px`, position: 'relative' }}
              />
              {effects.map((effect) => (
                <div
                  key={effect.id}
            ...
            <div className='fighter2'>
              <img
                className='fighter2Img'
                src={FightImg2}
                alt=''
                style={{ top: `${fighter2Top}px`, position: 'relative' }}
              />
          ...
          <div className='circlesBox'>
            <div className='arrows'>
              <div className=''>
                <img
                  className='circle-image move-up'
                  src={UpImg}
                  onClick={moveUp}
                  alt=''
                />
              ...
              <div className=''>
                <img
                  className='circle-image move-down'
                  src={DownImg}
                  onClick={moveDown}
                  alt=''
                />
